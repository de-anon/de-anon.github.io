...
(function initSharePanel() {
    ...
    function build() {
        ...
        // -------- НОВЫЙ МАССИВ СОЦСЕТЕЙ С КАСТОМНЫМИ SVG --------
        const socials = [
            {
                name: 'Telegram',
        ...
        socials.forEach(social => {
            ...
            // Создаём SVG с кругом и контентом
            const svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
            ...
            // Круг (фон) — заполняет всю область viewBox
            ...
            // Вставляем содержимое (белые path / ellipse)
            svg.insertAdjacentHTML('beforeend', social.content);
            ...
            // При наведении меняем цвет круга
        ...
        // -------- СТИЛИ (ОБНОВЛЕНЫ ДЛЯ НОВОЙ КНОПКИ) --------
        const style = document.createElement('style');
        style.textContent = `
