    ...
    function build() {
        ...
        const socials = [
            ...
            },
            {
                ...
                content: `<circle cx="35" cy="38" r="8" fill="#ffffff" /><circle cx="63" cy="38" r="8" fill="#ffffff" /><path d="M30 52 Q49 68 68 52" stroke="#ffffff" stroke-width="6" fill="none" stroke-linecap="round" />`
            },
            {
                name: 'ВКонтакте',
